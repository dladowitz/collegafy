class Poster < ActiveRecord::Base
  ...
  def self.post_to_college_central_network(job)
    ...
    approved_colleges.each do |college|
      ...
      if college.job_postings.where(title: job[:title], company: job[:company]).any?
  ...
  def self.current_job
    ...
    jobs[0] = {
      ...
      desta_url: "desta.co\/job\/opt-specialist/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push",
      ...
      job_description: "<a href=\"https:\/\/desta.co/job/opt-specialist/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push\">Apply Here</a> <br><br>
...
As they get older, they begin taking overnight trips to the beautiful Adirondacks where they will spend time hiking, rock climbing, rappelling, and camping—all while also learning about the endless varieties that nature has to offer. These trips get progressively more adventurous as the campers become more mature, but every trip is lead by outdoor adventure specialists who have been vigorously trained. All adventure staff are also certified lifeguards by The American Red Cross, trained to the ACCT Challenge Course Practioner standards, and trained in single pitch climbing & anchors building.",
    ...
    jobs[1] = {
      ...
      desta_url: "desta.co\/job\/tour-guide/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push",
      ...
      job_description: "<a href=\"https:\/\/desta.co/job/tour-guide/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push\">Apply Here</a> <br><br>
...
• Employee housing is available on a part-time or full-time basis.<br><br>",
    ...
    jobs[2] = {
      ...
      desta_url: "desta.co\/job\/o-r-e-river-guide/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push",
      salary: "$75 - $150 a day",
      location_wanted: ["OR"],
      region: "Beavercreek",
      location_zip: "97004",
      ...
      job_description: "<a href=\"https:\/\/desta.co/job/o-r-e-river-guide/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push\">Apply Here</a> <br><br>
    ...
    jobs[3] = {
      ...
      desta_url: "desta.co\/job\/guide-kodiad-raspberry-island-remote-lodge/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push",
      ...
      job_description: "<a href=\"https:\/\/desta.co/job/guide-kodiad-raspberry-island-remote-lodge/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push\">Apply Here</a> <br><br>
...
On both kayaking/hiking guide days as well as deckhand days, the guide is expected to help outfit our guests in rain gear, boots, etc as needed at 8:00 a.m. and to help load the boat in the morning, as well as meet the boat on the beach at day’s end to help unload, clean, and prep the boat when the boat returns to the mooring.",
    ...
    jobs[4] = {
      ...
      desta_url: "desta.co\/job\/wilderness-packer/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push",
      salary: "Depends on experience",
      location_wanted: ["MT"],
      region: "Augusta",
      location_zip: "59410",
      ...
      job_description: "<a href=\"https:\/\/desta.co/job/wilderness-packer/?utm_source=collegecentral&utm_medium=jobboards&utm_campaign=bot-push\">Apply Here</a> <br><br>
